                    ...
                    {navs.map((nav, i) => (
                        <Link key={i} href={nav.url}>
                            <a
                                className={
                                    active == nav.url
                                        ? `block text-center text-gray-100 px-3 md:px-5 pt-2 pb-1 duration-300 bg-yellow-800 dark:bg-gray-900`
                                        : `block text-center text-gray-100 px-3 md:px-5 pt-2 pb-1 duration-300 bg-yellow-700 hover:bg-yellow-800 dark:bg-gray-900 dark:bg-opacity-20 dark:hover:bg-gray-900`
                                }
                            >
                                <ion-icon
                                    name={
